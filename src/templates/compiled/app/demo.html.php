...
<a href="#" class="badge"><span class="label">A badge link</span></a>
<a href="#" class="badge badge-primary"><span class="icon"><span class="icon-cog"></span></span><span class="label">An icon link</span></a></p>
</div>
</div>
<div class="block">
<div class="block-header">
...
<p>
<span class="badge"><span class="icon"><span class="icon-home"></span></span><span class="label">Default</span></span>
<span class="badge badge-primary"><span class="icon"><span class="icon-flag"></span></span><span class="label">Primary</span></span>
<span class="badge badge-light"><span class="icon"><span class="icon-flag"></span></span><span class="label">Light</span></span>
<span class="badge badge-dark"><span class="icon"><span class="icon-flag"></span></span><span class="label">Dark</span></span>
<span class="badge badge-info"><span class="icon"><span class="icon-info"></span></span><span class="label">Info</span></span>
<span class="badge badge-success"><span class="icon"><span class="icon-checkmark"></span></span><span class="label">Success</span></span>
<span class="badge badge-warning"><span class="icon"><span class="icon-warning"></span></span><span class="label">Warning</span></span>
<span class="badge badge-error"><span class="icon"><span class="icon-close"></span></span><span class="label">Error</span></span></p>
</div>
</div>
</div>
<div class="cell">
...
<button type="button"><span class="label">Save</span></button>
<button type="button"><span class="label">Cancel</span></button>
<button type="button"><span class="label">OK</span></button>
</span>
</p>
<p>
...
<button type="button"><span class="label">Save</span></button>
<button type="button" class="active"><span class="label">Cancel</span></button>
<button type="button"><span class="label">OK</span></button>
</span>
</p>
<p>
...
<button title="Save" type="button" class="button-xs"><span class="icon"><span class="icon-disk"></span></span></button>
<button title="Cancel" type="button" class="button-xs"><span class="icon"><span class="icon-close"></span></span></button>
<button title="Ok" type="button" class="button-xs"><span class="icon"><span class="icon-checkmark"></span></span></button>
</span>
                            With context:
<span class="button-group">
<button title="Save" type="button" class="button-xs button-primary"><span class="icon"><span class="icon-disk"></span></span></button>
<button title="Cancel" type="button" class="button-xs button-error"><span class="icon"><span class="icon-close"></span></span></button>
<button title="Ok" type="button" class="button-xs button-success"><span class="icon"><span class="icon-checkmark"></span></span></button>
</span>
</p>
</div>
</div>
...
<p>
<button type="button" class="button-xs"><span class="icon"><span class="icon-plus"></span></span><span class="label">Extra small</span></button>
<button type="button" class="button-sm"><span class="icon"><span class="icon-download"></span></span><span class="label">Small</span></button>
<button type="button"><span class="icon"><span class="icon-enter"></span></span><span class="label">Default</span></button>
<button type="button" class="button-lg"><span class="icon"><span class="icon-flag"></span></span><span class="label">Large</span></button>
</p>
<p>
<button title="Extra small" type="button" class="button-xs"><span class="icon"><span class="icon-plus"></span></span></button>
<button title="Small" type="button" class="button-sm"><span class="icon"><span class="icon-download"></span></span></button>
<button title="Default" type="button"><span class="icon"><span class="icon-enter"></span></span></button>
<button title="Large" type="button" class="button-lg"><span class="icon"><span class="icon-flag"></span></span></button>
</p>
</div>
</div>
<div class="block">
...
<ul>
<li>
<a href="#"><span class="icon"><span class="icon-plus"></span></span><span class="label">A menu item</span>
</a>
</li>
<li>
<a href="#"><span class="icon"><span class="icon-download"></span></span><span class="label">A menu item</span>
</a>
</li>
<li>
<a href="#"><span class="icon"><span class="icon-enter"></span></span><span class="label">A menu item</span>
</a>
</li>
<li>
<a><span class="icon"><span class="icon-newspaper"></span></span><span class="label">A submenu</span>
</a>
<ul>
<li>
<a href="#"><span class="label">A submenu item</span>
</a>
</li>
</ul></li>
</ul></div>
...
<div class="field">
<label>Disabled select multiple</label>
...
</div><div class="field field-primary">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
</div><div class="field field-light">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
</div><div class="field field-dark">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
</div><div class="field field-info">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
</div><div class="field field-success">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
</div><div class="field field-warning">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
</div><div class="field field-error">
<div class="input-group">
<div class="input-group-text">http://</div>
<input type="text" placeholder="domain" />
<div class="input-group-button">
...
<section class="frame">
<div class="frame-header">Progress bars</div>
<div class="frame-content">
...
<button data-play="animate">play</button>
<button data-play="back">back</button>
<button data-play="forward">forward</button>
</div>
</div>
</div>
<div class="cell">
